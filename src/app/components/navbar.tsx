    ...
    return <>
        <nav className="flex items-center justify-between py-6 w-full backdrop-blur-sm" aria-label="navegacao">
            ...
            <div className="hidden lg:flex lg:gap-x-12">
                ...
                {isLoggedIn ? <form action={signoutAction}><button className="cursor-pointer hover:text-green text-sm font-semibold leading-6 text-gray">Sair</button></form>
                    : <a href='/auth'
                         className="cursor-pointer hover:text-green text-sm font-semibold leading-6 text-gray">Admin</a>}
            </div>
        </nav>
        <Dialog className="lg:hidden" open={mobileMenuOpen} onClose={setMobileMenuOpen}>
            ...
            <Dialog.Panel
                ...
                <div className="space-y-2 py-6">
                    ...
                    {isLoggedIn ? <form action={signoutAction}><button className="mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900">Sair</button></form>
                        : <a href='/auth'
                             className="mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900">Admin</a>}
                </div>
            </Dialog.Panel>
        </Dialog>
    </>
